...
El catálogo publicado en el Sitio tiene carácter **meramente informativo y orientativo**. Las descripciones, imágenes, unidades de medida y disponibilidades pueden variar sin previo aviso. **No constituye una oferta firme de venta.**

## 4. Precios y disponibilidad

- Los precios, cuando se exhiban, son de referencia y **pueden ser modificados** sin notificación previa debido a la volatilidad del mercado mayorista.
- La disponibilidad de los productos está sujeta a stock real al momento de la consulta.
- El presupuesto final se confirma únicamente por escrito a través de los canales oficiales de contacto (WhatsApp o email).

## 5. Uso del Sitio

El usuario se compromete a:
- Utilizar el Sitio únicamente para fines lícitos.
- No intentar acceder, alterar o manipular datos que no le correspondan.
- No emplear el Sitio para realizar actividades que infrinjan la legislación vigente.
